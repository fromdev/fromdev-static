        ...
        if (this.options.delaySubmit) {
        	...
        	if (this.checkout_vars.requiredFieldMessage) {
                ...
                on0.attr({
                    ...
                    var fldParent = $('#on0').parent();
                	fldParent.css({"color": "red", "border": "2px solid red"});
                	fldParent..append( '<p>' + this.checkout_vars.requiredFieldMessage + '</p>' )
                	//alert(this.checkout_vars.requiredFieldMessage);
                	return;
                }
            } else {
